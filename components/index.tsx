import { LoginButtons } from '@/components/register/register';
                    ...
                    >
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                ...
                                <div
                                    id="dropdown"
                                    className="hidden z-10 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700"
                                >
                                    <ul
                                    ...
                                    >
                                        ...
                                        <li>
                                            <button
                                                id="submenu-dropdown-button"
                                                data-dropdown-toggle="submenu-dropdown"
                                                data-dropdown-placement="right-end"
                                                type="button"
                                                className="flex justify-between items-center py-2 px-4 w-full hover:text-primary-600 dark:hover:text-primary-500"
                                            >
