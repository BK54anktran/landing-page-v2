...
const qa = [
    ...
    [
        ...
        {
            question: 'Mất bao lâu sau khi thanh toán thì tôi có thể sử dụng Thinkmay CloudPC',
        ...
        {
            question: 'Chính sách hoàn tiền của Thinkmay nếu người dùng dùng gặp lỗi là gì',
    ...
    [
        ...
        {
            question: 'Làm sao nếu tất cả các cách trên đều không giải quyết được vấn đề',
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-lg text-center">
                    ...
                    <p className="mb-8 text-gray-500 lg:text-lg dark:text-gray-400">
                        Bạn có thể nhắn tin trong phần hỗ trợ người dùng nếu bạn có những câu hói khác
                    </p>
                </div>
