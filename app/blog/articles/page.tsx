    ...
    return (
        <>
            <main className="bg-white dark:bg-gray-900 antialiased">
                <div className="flex justify-between mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:py-24 pt-20 sm:pt-24 lg:pt-32">
                    <div className="hidden mb-6 xl:block lg:w-52">
                        <div className="sticky top-20">
                            <aside
                                aria-labelledby="reactions-label"
                                className="mb-2"
                            >
                                <h3 id="reactions-label" className="sr-only">
                                    Reactions
                                </h3>
                                ...
                                <nav className="p-6 mb-6 font-medium text-gray-500 rounded-lg border border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                    <ul className="mb-6 space-y-4">
                                        <li>
                                            <a
                                                href="#"
                                                className="flex items-center text-primary-700 dark:text-primary-500"
                                            >
                                                <svg
                                    ...
                                    <h4 className="mb-4 text-gray-900 dark:text-white">
                                        Others
                                    </h4>
                    ...
                    <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                        <header className="mb-4 lg:mb-6 not-format">
                            <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">
                                Prototyping from A to Z: best practices for
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div
                                id="tooltip-save"
                                role="tooltip"
                                className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-xs opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700"
                            >
                                Save this article
                                <div
                                ...
                                <div className="flex">
                                    <div className="mr-4">
                                        <div className="rounded-lg bg-gray-100 w-9 flex flex-col items-center justify-center font-medium dark:bg-gray-700">
                                            <button
                                                type="button"
                                                className="text-gray-500 dark:text-gray-400 py-1 dark:hover:bg-gray-600 rounded-t-lg hover:bg-gray-200 w-full focus:ring-2 focus:outline-none focus:ring-gray-50 dark:bg-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                            >
                                                +
                                            </button>
                                            ...
                                            <button
                                                type="button"
                                                className="text-gray-500  dark:text-gray-400 py-1 dark:hover:bg-gray-600 rounded-b-lg hover:bg-gray-200 w-full focus:ring-2 focus:outline-none focus:ring-gray-50 dark:bg-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                            >
                                                -
                                            </button>
                                        </div>
                                    ...
                                    <div className="w-full">
                                        <footer className="flex justify-between items-center mb-2 w-full">
                                            ...
                                            <div
                                                id="dropdownComment1"
                                                className="hidden z-10 w-36 bg-white rounded-sm divide-y divide-gray-100 shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                                            >
                                                <ul
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">
                                            ...
                                            designer should consider while
                            ...
                            <article className="p-4 lg:p-6 mb-6 text-base bg-white border border-gray-100 dark:border-gray-700 rounded-lg dark:bg-gray-800">
                                <div className="flex">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">
                                            Very straight-to-point article.
                                            Really worth time reading. Thank
                                            you! But tools are just the
                                            instruments for the UX designers.
                                            The knowledge of the design tools
                                            are as important as the creation of
                                            the design strategy.
                                        </p>
                                        <div className="flex items-center mt-4 space-x-4">
                                            <button
                            ...
                            <article className="p-4 lg:p-6 mb-6 text-base bg-white border border-gray-100 dark:border-gray-700 rounded-lg dark:bg-gray-800">
                                <div className="flex">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">
                                            Thanks for sharing this. I do came
                                            from the Backend development and
                                            explored some of the tools to design
                                            my Side Projects.
                                        </p>
                                        <div className="flex items-center mt-4 space-x-4">
                                            <button
                    ...
                    >
                        <div className="sticky top-20">
                            ...
                            <div className="p-6 mb-6 text-gray-500 rounded-lg border border-gray-200 dark:border-gray-700 dark:text-gray-400">
                                ...
                                <dl className="mb-5">
                                    <dt className="mb-2 text-sm font-bold text-gray-900 uppercase dark:text-white">
                                        Location
                                    </dt>
                                    <dd className="mb-3 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <form className="mb-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="search"
                                            id="default-search"
                                            className="block py-2.5 pl-9 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Search..."
                                            required
                                        />
                                    </div>
                                </form>
                                <h4 className="mb-6 font-bold text-gray-900 uppercase dark:text-white">
                                    Recommended topics
                                </h4>
                                <div className="flex flex-wrap">
                                    <a
                                        href="#"
                                        className="bg-primary-100 text-primary-800 text-sm font-medium mr-3 px-2.5 py-0.5 rounded-sm dark:bg-primary-900 dark:text-primary-300 mb-3"
                                    >
                                        Technology
                                    </a>
                                    <a
                                    ...
                                    <a
                                        href="#"
                                        className="bg-primary-100 text-primary-800 text-sm font-medium mr-3 px-2.5 py-0.5 rounded-sm dark:bg-primary-900 dark:text-primary-300"
                                    >
                                        Mindfulness
                                    </a>
                                </div>
                            </div>
                            <div className="p-6 font-medium text-gray-500 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                                <h4 className="mb-6 font-bold text-gray-900 uppercase dark:text-white">
                                    Who to follow
                                </h4>
                ...
                <div className="px-4 mx-auto max-w-screen-xl">
                    ...
                    <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                        <article className="max-w-xs">
                            ...
                            <a
                                href="#"
                                className="inline-flex items-center font-medium underline underline-offset-4 text-primary-700 dark:text-primary-500 hover:no-underline"
                            >
                                Read in 2 minutes
                            </a>
                        </article>
            ...
            <section className="bg-white dark:bg-gray-900 antialiased">
                <div className="p-4 py-12 mx-auto max-w-screen-xl text-center lg:py-24">
                    <h2 className="mx-auto mb-6 max-w-2xl text-2xl font-extrabold leading-tight text-gray-900 lg:text-4xl dark:text-white">
                        Join a growing community of millions of developers and
                        designers!
                    </h2>
                    ...
                    <a
                        href="#"
                        className="py-3 px-5 w-full text-sm font-medium text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                    >
                        Create an account
                    </a>
                </div>
